% \usepackage[english]{babel} % english, USenglish, american, UKenglish, british, canadian, australian, newzealand
...
\usepackage[caption=false]{subfig} % font=normalsize,labelfont=sf,textfont=sf
...
% \usepackage{chngcntr} % Number figures and tables per chapter
